...
import (
	...
	"cchalop1.com/deploy/internal/querybuilder"
)
...
func (r *Golang) Build(args []string, opts ...GolangBuildOpts) *Directory {
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		if !querybuilder.IsZeroValue(opts[i].Project) {
			q = q.Arg("project", opts[i].Project)
		}
	}
	q = q.Arg("args", args)
